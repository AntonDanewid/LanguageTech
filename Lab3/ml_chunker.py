...
def predict(test_sentences, feature_names, f_out):
    ...
    for test_sentence in test_sentences:
        X_test_dict, y_test = extract_features_sent(test_sentence, w_size, feature_names, True)
        chunk_n2 = 'BOS'
        chunk_n1 = 'BOS'
        y_test_predicted = []
        ...
        for entry in X_test_dict:
            entry['chunk_n2'] = chunk_n2
            entry['chunk_n1'] = chunk_n1
            current_X = vec.transform(entry)
            current_y = classifier.predict(current_X)
            y_test_predicted.extend(current_y)
            chunk_n2 = chunk_n1
            chunk_n1 = current_y[0]
